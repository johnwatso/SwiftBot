...
enum DiscordPermissionCatalog {
    static let all: [DiscordPermissionFlag] = [
        ...
        .init(id: "manageroles", bit: 28, name: "Manage Roles",
              detail: "Grant or remove roles for Welcome Flow next steps and automation steps.",
              severity: .recommended),
        .init(id: "managechannels", bit: 4, name: "Manage Channels",
              detail: "Create channels from automation steps and manage channel-based automations.",
              severity: .recommended),
        ...
        .init(id: "movemembers", bit: 24, name: "Move Members",
              detail: "Move members between voice channels from automation steps.",
              severity: .recommended),
        .init(id: "mutemembers", bit: 22, name: "Mute Members",
              detail: "Mute members in voice channels when moderation automations need it.",
              severity: .optional),
        .init(id: "deafenmembers", bit: 23, name: "Deafen Members",
              detail: "Deafen members in voice channels when moderation automations need it.",
              severity: .optional),
        .init(id: "managenicknames", bit: 27, name: "Manage Nicknames",
              detail: "Change other members' nicknames for moderation automations.",
              severity: .optional),
