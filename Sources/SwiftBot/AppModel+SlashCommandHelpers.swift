    ...
    func allSlashCommandDefinitions() -> [[String: Any]] {
        var definitions: [[String: Any]] = [
            ...
            ["name": "miner", "description": "Check or set up your SwiftMiner drops miner", "type": 1, "options": [
                ["type": 3, "name": "action", "description": "status | setup | games | prioritise | pause | resume | refresh | health", "required": false, "choices": [
            ...
            ["name": "announce", "description": "Control your configured Announcer voice channel", "type": 1, "options": [
                ["type": 3, "name": "action", "description": "join | rejoin | disconnect", "required": false, "choices": [
